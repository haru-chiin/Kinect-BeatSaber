	...
	void Update()
	{
		if(KinectInitialized)
		{
			...
			if(Player1Calibrated)
			{
                ...
                var gesturesCopy = new List<KinectGestures.GestureData>(player1Gestures);
                // Check for complete gestures
                foreach (var gestureData in gesturesCopy)
				{
...
//							
//							if(CalibrationText)
//								CalibrationText.UnityEngine.UI.Text.text = debugText;
//						}
					}
